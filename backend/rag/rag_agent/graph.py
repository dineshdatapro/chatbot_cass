...
def create_agent_graph(llm, tools_list):
    try:
        ...
        raise ImportError("langgraph is required to build the agent graph.") from exc
    ...
    graph_builder.add_node("direct_response", partial(direct_response, llm=llm))
    ...
    graph_builder.add_edge("summarize_history", "classify_intent")
    graph_builder.add_conditional_edges(
        "classify_intent",
        route_after_intent,
        {"direct_response": "direct_response", "rewrite_query": "rewrite_query"},
    )
